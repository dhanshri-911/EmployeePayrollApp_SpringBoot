...
public class EmployeePayrollController {
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrollData() {
        ...
        employeePayrollData = new EmployeePayrollData(1, new EmployeePayrollDTO("Dhanshri", 5000));
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrollData(@PathVariable int empID) {
        EmployeePayrollData employeePayrollData;
        employeePayrollData = new EmployeePayrollData(empID, new EmployeePayrollDTO("Harshu", 10000));
